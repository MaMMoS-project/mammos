...
cube = geompy.MakeBoxDXDYDZ(4, 4, 4)
geompy.TranslateDXDYDZ(cube, -2, -2, -2)
Sphere_1 = geompy.MakeSphereR(4)
Sphere_2 = geompy.MakeSphereR(6)
...
NETGEN_3D_Parameters_1.SetLocalSizeOnShape(a1, 2)

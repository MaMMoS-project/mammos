...
## [mammos 0.13.0](https://github.com/MaMMoS-project/mammos/tree/0.13.0) – 2026-04-22

### Misc

- New Sphinx role `:entity:` to annotate ontology labels. ([#85](https://github.com/MaMMoS-project/mammos/pull/85))


## [mammos 0.12.1](https://github.com/MaMMoS-project/mammos/tree/0.12.1) – 2026-03-10

No significant changes.


## [mammos 0.12.0](https://github.com/MaMMoS-project/mammos/tree/0.12.0) – 2026-03-06

### Misc

- Documentation: update mammos components diagram in design section (adding ai) ([#64](https://github.com/MaMMoS-project/mammos/pull/64))
